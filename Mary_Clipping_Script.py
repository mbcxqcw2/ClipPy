...
proc_remainder = True  # option to process remainder samples which do not fit into an integer number of toload_samps. If "True", may decrease S/N of clipped file compared to if "False". Needs testing before default is changed to true in clip_filterbanks_2.
